...
static MANIFEST: &[u8] = br#"{"plugin_type":"connector.okx","name":"OKX Connector Plugin","version":"0.1.0","engine_api_version":{"major":2,"minor":0},"abi_version":{"major":1,"minor":0},"config_schema_version":1,"config_schema":{"type":"object"},"provides":[],"requires":[],"publishes":[],"subscribes":[],"supported_execution_models":["Passive"],"reload_policy":"RestartRequired"}"#;
...
unsafe extern "C" fn create(
    ...
    unsafe { dynamic_plugin::create_root_from_json(DynamicVenue::Okx, input, length, output) }
}
