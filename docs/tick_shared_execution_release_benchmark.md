...
## ABI v8 与任务复审修复复验（2026-08-24）

加入 Funding ABI v8、结构化 runtime source error、真实 process CPU time、Bar 持久动作调度器及
P2 Bar 平台接线后，重新构建 release benchmark，并以相同的 100 万事件、30 轮、5 轮 warmup
连续执行三次：

| 样本 | Noop events/s | OutcomeBus events/s | 回归 |
|---|---:|---:|---:|
| 1 | 11,876,981 | 12,627,719 | -5.945% |
| 2 | 8,192,715 | 8,103,989 | +1.095% |
| 3 | 12,030,060 | 11,426,125 | +5.286% |
